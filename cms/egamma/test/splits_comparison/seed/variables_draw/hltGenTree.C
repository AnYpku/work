...
het[1] = new TH1D("het_eghlt","et",20,0,400);
heta[0] = new TH1D("hdetEta_ele","detEta",10,0,2.5);
heta[1] = new TH1D("heta_eghlt","eta",10,0,2.5);
Hadem[0] = new TH1D("hadem_ele","HoverE",10,0,5);
Hadem[1] = new TH1D("hadem_eghlt","HoverE",10,0,5);
...
tree->Branch("eleTruthNrgy",&eleTruthNrgy,"eleTruthNrgy/F");*/
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      if(clusEt>200) clusEt =199; if(egHLT_et>200) egHLT_et =199;
...
//      if( !(  (fabs(eleTruthEta)>1.566)&&(fabs(eleTruthEta)<2.5) ) ) continue;
      ...
      Hadem[0]->Fill(hadem);Hadem[1]->Fill(egHLT_hadem);hnrgy[0]->Fill(clusNrgy);hnrgy[1]->Fill(egHLT_nrgy);
