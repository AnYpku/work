...
het[1] = new TH1D("het_eghlt","et",20,0,200);
Hadem[0] = new TH1D("hadem_ele","HoverE",20,0,0.1);
Hadem[1] = new TH1D("hadem_eghlt","HoverE",20,0,0.1);
...
heta[1] = new TH1D("heta_eghlt","eta",25,0,2.5);
...
//      if( !(  (fabs(eleTruthEta)>1.566)&&(fabs(eleTruthEta)<2.5) ) ) continue;
      ...
      Hadem[0]->Fill(hadem);Hadem[1]->Fill(egHLT_hadem);
