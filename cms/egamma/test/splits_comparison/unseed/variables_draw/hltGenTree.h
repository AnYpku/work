...
// Fixed size dimensions of array or collections stored in the TTree if any.
 ...
 //EleStructs::EleStruct *ele;
   ...
   virtual void     endJob(TString name,int j,int i);
...
void hltGenTree::endJob(TString name,int j,int i){
/*for(int i=0;i<2;i++){
delete het[i];
delete hnrgy[i];
delete heta[i];
...
delete file;
//cout<<j<<"\t"<<barreletabins[j]<<"<eta<"<<barreletabins[j+1]<<endl;
//cout<<j<<"\t"<<endcapetabins[j]<<"<eta<"<<endcapetabins[j+1]<<endl;
cout<<j<<"\t"<<etabins[j]<<"<eta<"<<etabins[j+1]<<endl;
cout<<i<<"\t"<<etbins[i]<<"<et<"<<etbins[i+1]<<endl;
