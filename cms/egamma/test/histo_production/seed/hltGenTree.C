...
heta[0] = new TH1D("hdetEta_ele","detEta",10,-1.5,1.5);
//heta[0] = new TH1D("hdetEta_ele","detEta",10,-2.5,2.5);
...
heta[1] = new TH1D("heta_eghlt","eta",10,-1.5,1.5);
//heta[1] = new TH1D("heta_eghlt","eta",10,-2.5,2.5);
...
h2phi[0] = new TH2D("hphi1_seed","eleTruthPhi",16,-3.2,3.2,1,-2000,2000);
h2phi[1] = new TH2D("hphi2_seed","eleTruthPhi",16,-3.2,3.2,1,-2000,2000);
h2phi[2] = new TH2D("hphi1_US","eleTruthPhi",16,-3.2,3.2,1,-2000,2000);
h2phi[3] = new TH2D("hphi2_US","eleTruthPhi",16,-3.2,3.2,1,-2000,2000);
...
//     if(jentry%1000==0&&egHLT_et>0){ cout<<jentry<<";"<<egHLT_et<<"; "<<egHLT_eta<<";"<<egHLT_nrgy<<endl;}
      ...
      if(egHLT_et>200) egHLTUS_et =199;
