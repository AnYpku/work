...
//		hegHLT[i]->Write();
	...
	for(int i=0;i<9;i++){
		TString name = hegHLT[i]->GetTitle();
		cout<<name<<endl;
        if(filename.Contains("200"))hegHLT[i]->SetTitle(name +" comparison in Z mass"+tag2+" and "+region+" region");          
        else hegHLT[i]->SetTitle(name +" comparison in Z mass"+tag1+" and "+region    +" region;"+name+";yields");
