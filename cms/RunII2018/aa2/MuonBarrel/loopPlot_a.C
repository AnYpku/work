...
void loopPlot() {
	...
	std::string pathToTrees = "/uscms_data/d3/qliphy/andy/CMSSW_10_2_10/small/cutla/";
...
// set mc imformation
		...
		std::string mcLabels[nMC] = {"ST", "TTA", "VV",
                                            "plj_weightb","ZA"};//,"Contamination_ZA"};
		double kFactorsMC_array[nMC+1] = { lumiValue,lumiValue,lumiValue,1,lumiValue,1};
                const int nMC2 = 1;      
