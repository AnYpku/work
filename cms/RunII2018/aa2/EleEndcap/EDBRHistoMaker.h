...
void EDBRHistoMaker::Loop(std::string outFileName) {
	...
	double r2=gRandom->Rndm(jentry*2);
		...
		if (drll>0.3 && (isnotwets > 0 || iswjets > 0 || iszjets > 0 || isttjets > 0)&&/*l1_weight==1&&*/lep == 11 &&  (HLT_Ele2 > 0|| HLT_Ele1 > 0) && ptlep1 > 25. && ptlep2 > 25. && fabs(etalep1) < 2.5 && fabs(etalep2) < 2.5 && nlooseeles < 3 && nloosemus == 0 && massVlep > 70. && massVlep < 110. && photonet > 25.&& ( fabs(photoneta)<2.5&&fabs(photoneta)>1.566 ) && jet1pt> 30 && jet2pt > 30 && fabs(jet1eta)< 4.7 && fabs(jet2eta)<4.7 && Mjj > 150) {
