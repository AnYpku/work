...
int main(){
	...
	Double_t lumi=41.52;
//	Double_t mjj_bins[4]={500, 800, 1000, 2000};
	Double_t mjj_bins[4]={500, 800, 1200, 2000};
//        Double_t mlla_bins[5]={90, 130, 170, 210, 240};
//        Double_t detajj_bins[4]={2.5,4.5,6,6.5};
    Double_t detajj_bins[4]={2.5, 4., 5.5, 6.5};
...
//        TH1D* t_ST=unroll(th2_ST, mjj_bins, mlla_bins, 4,4);
    ...
    vector<TH1D*> histo1d;
    histo1d.push_back(t_ST);
    histo1d.push_back(t_TTA);
    histo1d.push_back(t_WA);
    histo1d.push_back(t_VV);
    histo1d.push_back(t_plj);
    histo1d.push_back(t_ZA_sig);
    ...
    TCanvas*c[6];
    for(Int_t j=0;j<histo1d.size();j++){
       c[j] = new TCanvas(Form("c_%0.d",j),"MC disribution",700,600);
       c[j]->cd();
       histo1d[j]->Draw("hist");       
       c[j]->Print("./eps/"+histoname[j]+".eps");
    }
	...
	TCanvas* c1=new TCanvas("","",750,600);
	c1->cd();
