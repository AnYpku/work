...
TCanvas *c1=new TCanvas("c1","Zjets and leading photon",900,600);   
 ...
 h11->SetTitle("Zjetscuts and Leading photon and loose ID ");
...
// h13->Scale(s3);
 ...
 l1->AddEntry(h12,"0.1<photon_chiso<10");
...
TCanvas *c2=new TCanvas("c2","two dimension distribution",900,600);
 c2->SetLogz();
 hh11->SetTitle("ZJetscut&&Leading photon&&looseID&&photon_chiso[0]<0.441; photon_sieie; photon_chiso");
 //h3->Draw("COLTEXTZ");
...
TCanvas *c3=new TCanvas("c3","two dimension distribution",900,600);
 c3->SetLogz();
 hh12->SetTitle("Zjets&&Leading photon&&looseID&&0.1<photon_chiso[0]<10; photon_sieie; photon_chiso");
 //h33->Draw("COLTEXTZ");
...
TCanvas *c4=new TCanvas("c4","two dimension distribution",900,600);
 c4->SetLogz();
 hh13->SetTitle("Zjets&&Leading photon&&looseID&&2<photon_chiso[0]<4; photon_sieie; photon_chiso");
 //h33->Draw("COLTEXTZ");
