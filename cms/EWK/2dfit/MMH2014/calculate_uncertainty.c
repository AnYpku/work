...
Int_t histo_number=50;
Double_t central_value[9],nlo_value[50][9];//[the amount of pdf][the amout of bin]
ofstream f1("./MMH-uncertainty.txt");
void open(Int_t i){
    ifstream file(Form("./MMH-txt/content-hist_%d",i));
