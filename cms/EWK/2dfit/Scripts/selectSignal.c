...
//    t1->Add("/afs/cern.ch/work/y/yian/Ntuple/CMSSW_8_0_26_patch2/src/analysis_code/step1_add_weight/outps_*.root");
    ...
    int nlooseeles,nloosemus,HLT_Ele2,lep;
	...
	TFile *newfile = new TFile("outZA-cut2.root", "recreate");
...
//    nentries=10000;
    for (int i = 0; i < nentries; i++) {
      ...
      LEP = ptlep1 > 25. && ptlep2 > 25.&& fabs(etalep1) < 2.5 &&abs(etalep2) < 2.5 && nlooseeles < 3 && nloosemus == 0  && massVlep >70. && massVlep < 110; 
      SignalRegion= Mjj>500 && deltaetajj>2.5 && zepp<1.8;
      PHOTON= photonet>25 && fabs(photoneta)<1.442;
