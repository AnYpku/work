...
//	Double_t mjj_bins[4]={500, 800, 1200, 2000};
	...
	for(Int_t j=0; j<t->GetEntries();j++)
	{
        ...
        PHOTONe= photonet>20 &&((fabs(photoneta)<2.5&&fabs(photoneta)>1.566) /*|| fabs(photo    neta)<1.4442*/);
...
int d_hist(){
    cout<<"test"<<endl;
	run("/Users/andy/work/cms/EWK/2dfit/ControlRegion/outZA-mu-ele");
