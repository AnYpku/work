#define binnumber 1
void open(Int_t i);
Int_t p=binnumber;//the amount of bin
Int_t histo_number=102;
Double_t central_value[binnumber],nlo_value[102][binnumber];//[the amount of pdf][the amout of bin]
ofstream f1("./nnpdf-uncertainty.txt");
void open(Int_t i){
    ifstream file(Form("./txt/content-hist_%d",i));
...
gStyle->SetOptStat(0);
const char *name[binnumber]={"Mjj 150~400"};
TH1D* h1 =new TH1D("h1","uncertainty",binnumber,0,0.5);
