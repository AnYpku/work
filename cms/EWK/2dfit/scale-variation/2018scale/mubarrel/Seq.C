...
//cout<<"bin "<<j+1<<"; sum = "<<sum<<endl;
      cout<<"bin "<<j+1<<"; up uncertainty["<<j<<"] = "<<fixed<<setprecision(3)<<(biggest[j]-central_value[j])/central_value[j]<<endl;
      cout<<"bin "<<j+1<<"; down uncertainty["<<j<<"] = "<<fabs(smallest[j]-central_value[j])/central_value[j]<<endl;
