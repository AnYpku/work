...
TFile* fdata = TFile::Open("/Users/andy/work/cms/EWK/ZAp2jets/Data-Driven/make-template/root/Data_template-cutLEP-outDMuon.root");
TFile* ftrue = TFile::Open("/Users/andy/work/cms/EWK/ZAp2jets/Data-Driven/make-template/root/True_template-cutLEP-outZA.root");
TFile* ffake = TFile::Open("/Users/andy/work/cms/EWK/ZAp2jets/Data-Driven/make-template/root/Fake_template-cutLEP-outDMuon.root");
...
//TString b="chiso5-12_";
	...
	ofstream myfile(TString("fitresult_") + Form("photon_pt%0.f_%0.f.txt", lowpt, highpt),ios::out);
	ofstream file2(TString("fakerate_") + Form("pt%0.f_%0.f.txt", lowpt, highpt),ios::out);
