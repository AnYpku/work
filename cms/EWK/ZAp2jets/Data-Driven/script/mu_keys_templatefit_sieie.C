   ...
   //  for(int i=0;i<100000;i++)
    {
        ...
        for(Int_t iPhoton=0;iPhoton<6;iPhoton++){
                if(photon_pev_za[iPhoton]==1 &&
                   ...
                   photon_chiso_za[iPhoton] < 1.37 &&
                   photon_nhiso_za[iPhoton]<(1.06 + 0.014*photon_pt_za[iPhoton] + 0.000019*photon_pt_za[iPhoton]*photon_pt_za[iPhoton]) &&
                   photon_phoiso_za[iPhoton]<(0.28 + 0.0053*photon_pt_za[iPhoton]) &&
    ...
    //for(int i=0;i<1000;i++)
    {
        ...
        for(Int_t iPhoton=0;iPhoton<6;iPhoton++){
                if(photon_pev_tf[iPhoton]==1 &&
                   photon_hoe_tf[iPhoton]<0.05 && photon_chiso_tf[iPhoton] < 1.37 &&
                   photon_nhiso_tf[iPhoton]<(1.06 + 0.014*photon_pt_tf[iPhoton] + 0.000019*photon_pt_tf[iPhoton]*photon_pt_tf[iPhoton]) &&
                   photon_phoiso_tf[iPhoton]<(0.28 + 0.0053*photon_pt_tf[iPhoton]) &&
          ...
          for(int i=0;i<10;i++)
    {
        ...
        for(Int_t iPhoton=0;iPhoton<6;iPhoton++){
                if(photon_pev_dy[iPhoton]==1 &&
                   ...
                   photon_chiso_dy[iPhoton]<1.37 &&
                   photon_nhiso_dy[iPhoton]<(1.06 + 0.014*photon_pt_dy[iPhoton] + 0.000019*photon_pt_dy[iPhoton]*photon_pt_dy[iPhoton]) &&
                   photon_phoiso_dy[iPhoton]<(0.28 + 0.0053*photon_pt_dy[iPhoton]) &&
...
//>>>>>>>>>>>>>>>>>>WA Data>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    Long64_t nentries_data = t3->GetEntries();
  ...
  //      for(int i=0;i<1000;i++)
    {
				...
				for(Int_t iPhoton=0;iPhoton<6;iPhoton++){
                    if(photon_pev[iPhoton]==1 &&
                       ...
                       photon_pt[iPhoton]>lowpt && photon_pt[iPhoton]<highpt){
						...
						if(pass5>0 && photon_pt[iPhoton]>photon_pt[iPhoton12_data])
						  {
								iPhoton12_data = iPhoton;
								disc5++;
							}
						if(iPhoton12_data>0 && pass5==0 && photon_pt[iPhoton]>photon_pt[iPhoton12_data])
						  {
								iPhoton12_data = iPhoton;
								disc5++;
							}
        ...
        if(disc5>0 && photon_drla[iPhoton12_data]>0.4){
     //   if(disc5>0 && photon_drla_tf[iPhoton12_data]>0.4 && photon_drla2_tf[iPhoton12_data]>0.4){
					Sieie_data = photon_sieie[iPhoton12_data];
    ...
    Long64_t nentries_wa = t5->GetEntries();
    ...
    //           for(int i=0;i<1000;i++)
    {
        ...
        for(Int_t iPhoton=0;iPhoton<6;iPhoton++){
            if(photon_pev_wa[iPhoton]==1 &&
               photon_hoe_wa[iPhoton]<0.05 &&
               photon_chiso_wa[iPhoton]<1.37 &&
               photon_nhiso_wa[iPhoton]<(1.06 + 0.014*photon_pt_wa[iPhoton] + 0.000019*photon_pt_wa[iPhoton]*photon_pt_wa[iPhoton]) &&
               photon_phoiso_wa[iPhoton]<(0.28 + 0.0053*photon_pt_wa[iPhoton]) &&
               TMath::Abs(photon_eta_wa[iPhoton])<1.4442 &&
               photon_pt_wa[iPhoton]>lowpt && photon_pt_wa[iPhoton]<highpt){
                ...
                if(pass5>0 && photon_pt_wa[iPhoton]>photon_pt_wa[iPhoton12_wa])
                {
                    iPhoton12_wa = iPhoton;
                    disc5++;
                }
                if(iPhoton12_wa>0 && pass5==0 && photon_pt_wa[iPhoton]>photon_pt_wa[iPhoton12_wa])
                {
                    iPhoton12_wa = iPhoton;
                    disc5++;
                }
        ...
        if(disc5>0 && photon_drla_wa[iPhoton12_wa]>0.4){
      //  if(disc5>0 && photon_drla_za[iPhoton12_data]>0.4 && photon_drla2_za[iPhoton12_data]>0.4){

            Double_t weight_wa = pileupWeight_wa*lumiWeight_wa*triggerWeight_wa*scalef_wa*0.553;
            Sieie_wa = photon_sieie_wa[iPhoton12_wa];
