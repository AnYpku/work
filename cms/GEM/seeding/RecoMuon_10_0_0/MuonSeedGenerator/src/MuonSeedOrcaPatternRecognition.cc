...
//std::cout<<"newb "<<GEMDetId((*segmentItr)->geographicalId().rawId()).station()<<std::endl;
//std::cout<<"newc "<<GEMDetId((*segmentItr)->geographicalId().rawId()).layer()<<std::endl;
       // if(GEMDetId((*segmentItr)->geographicalId().rawId()).station()==1) {
        result.push_back(*segmentItr);
       // }
//      }
//      else
