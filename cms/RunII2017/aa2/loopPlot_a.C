...
void loopPlot() {
	...
	std::string pathToTrees = "/uscms_data/d3/qliphy/andy/CMSSW_9_4_9_cand2/small/cutla/";
...
// set mc imformation
		...
		std::string mcLabels[nMC] = {"ST", "TTA", "VV",
                                            "plj2_mubarrel","ZA","Contamination_ZA"};
		/*std::string mcLabels[nMC] = {"ZA"}; 
		double kFactorsMC_array[nMC] = { lumiValue};*/

		double kFactorsMC_array[nMC] = { lumiValue,lumiValue,lumiValue,1,lumiValue,-lumiValue};
