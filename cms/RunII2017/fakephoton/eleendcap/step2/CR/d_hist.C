...
//	t->SetBranchAddress("deltaetajj", &deltaetajj);
	...
	{
		t->GetEntry(j);
		if( !(lep==11 &&    (fabs(photoneta)<2.5&&fabs(photoneta)>1.566) ) ) continue;
...
int d_hist(){
	TH2D* h0 = run("/Users/andy/work/cms/RunII2017/fakephoton/optimal_2017_plj_elebarrel.root",0);
	TH2D* hup = run("/Users/andy/work/cms/RunII2017/fakephoton/optimal_2017_plj_elebarrel_up.root",1);
	TH2D* hdown = run("/Users/andy/work/cms/RunII2017/fakephoton/optimal_2017_plj_elebarrel_down.root",2);
