...
jer=[1.026,1.003,1.005,1.022,1.045,1.02,1.004,1.018]
...
scale_QCD=[1.15,1.18,1.12,1.09,1.09,1.08,1.16,1.10]
scale_ewk=[1.14,1.14,1.12,1.09,1.09,1.08,1.15,1.10]
fakephoton=[1.11,1.14,1.13,1.11,1.12,1.14,1.12,1.12];
QCDZA_scale_extra_down = [0.977,0.946,0.919,0.998,0.016,1.029,1.052,1.037];
...
# bin error
   ...
   f.write('JES_%s_%s\tlnN\t%0.2f\t%0.2f\t-\t%0.2f\t%0.2f\t%0.2f\t%0.2f\n'%('muon','barrel',jes[i-1],jes[i-1],jes[i-1],jes[i-1],jes[i-1],jes[i-1]))
   f.write('JER_%s_%s\tlnN\t%0.2f\t%0.2f\t-\t%0.2f\t%0.2f\t%0.2f\t%0.2f\n'%('muon','barrel',jer[i-1],jer[i-1],jer[i-1],jer[i-1],jer[i-1],jer[i-1]))
   ...
   f.write('trigger\tlnN\t1.02\t1.02\t-\t1.02\t1.02\t1.02\t1.02\n')
   f.write('lepton_efficiency\tlnN\t1.005\t1.005\t-\t1.005\t1.005\t1.005\t1.005\n')
