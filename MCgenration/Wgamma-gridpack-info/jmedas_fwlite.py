...
h_JECValueAK4 = ROOT.TH1F("h_JECValueAK4", "Value of JEC for AK4 Jet", 100, 0.8, 1.5)
...
h_JECValueAK8 = ROOT.TH1F("h_JECValueAK8", "Value of JEC for AK8 Jet", 100, 0.8, 1.5)
...
def getJER(jetEta, sysType) :
    ...
    etamin = [0.0,0.522,0.783,1.131,1.305,1.74,1.93,2.043,2.322,2.5,2.853,2.964,3.139]
    etamax = [0.522,0.783,1.131,1.305,1.74,1.93,2.043,2.322,2.5,2.853,2.964,3.139,5.191]

    scale_nom = [1.1595,1.1948,1.1464,1.1609,1.1278,1.1,1.1426,1.1512,1.2963,1.3418,1.7788,1.1869,1.1922]
    scale_unc = [0.0645,0.0652,0.0632,0.1025,0.0986,0.1079,0.1214,0.114,0.2371,0.2091,0.2008,0.1243,0.1488]
