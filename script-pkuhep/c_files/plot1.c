{
  ...
  #include <vector.h>
       ...
       TFile *file1 = new TFile("../root_files/DQM.root","R");
       file1->cd("DQMData/Run 1/Muons/Run summary/RecoMuonV/MultiTrack/standAloneMuons_UpdatedAtVtx_tpToStaUpMuonAssociation");
       TH1D* h1= (TH1D*) efficP->Clone();
  
       TFile *file2 = new TFile("DQM.root","R");
       file2->cd("DQMData/Run 1/Muons/Run summary/RecoMuonV/MultiTrack/standAloneMuons_UpdatedAtVtx_tpToStaUpMuonAssociation");
       TH1D* h2= (TH1D*) efficP->Clone();
       ...
       TLegend *l1 = new TLegend(0.4,0.22,0.85,0.45);
       l1->SetBorderSize(2);
       l1->SetFillColor(0);
  ...
  /*     TLatex *t = new TLatex();
       ...
       t->Draw();
  */
       c01->SaveAs("csc2-pt.png");
       c01->SaveAs("csc2-pt.pdf");
