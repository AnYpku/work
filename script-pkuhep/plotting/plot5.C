...
#include <vector.h>
     ...
     TH1D* h1= (TH1D*) qOverPtresXL_vs_eta_sim_Mean->Clone();
...
//     h1->GetYaxis()->SetRangeUser(0.6,1.05);
     ...
     //c01->SetLogy();
     h1->SetStats(kFALSE);
     h1->GetXaxis()->SetTitle("Mu sim #eta");
     ...
     TLegend *l1 = new TLegend(0.15,0.48,0.5,0.71);
     l1->SetBorderSize(2);
     l1->SetFillColor(0);
...
/*     TLatex *t = new TLatex();
     ...
     t->Draw();
*/
     c01->SaveAs("csc2-qOverPtres1_vs_eta_sim_Mean.eps");
     c01->SaveAs("csc2-qOverPtres1_vs_eta_sim_Mean.png");
     c01->SaveAs("csc2-qOverPtres1_vs_eta_sim_Mean.pdf");
