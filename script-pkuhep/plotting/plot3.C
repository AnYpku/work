...
//     h1->GetYaxis()->SetRangeUser(0.6,1.05);
     ...
     //c01->SetLogy();
     h1->SetStats(kFALSE);
     h1->GetXaxis()->SetTitle("inverse pt resolution");
     ...
     TLegend *l1 = new TLegend(0.115,0.45,0.455,0.73);
     l1->SetBorderSize(2);
     l1->SetFillColor(0);
...
/*     TLatex *t = new TLatex();
     ...
     t->Draw();
*/
//     c01->SaveAs("csc2-invptres.eps");
     c01->SaveAs("invptres-s2.eps");
//     c01->SaveAs("csc2-invptres.pdf");
