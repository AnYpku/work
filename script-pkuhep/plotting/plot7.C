...
#include <vector.h>
     ...
     h1->GetYaxis()->SetRangeUser(0.0,0.25);
     ...
     //c01->SetLogy();
     h1->SetStats(kFALSE);
     h1->GetXaxis()->SetTitle("Mu PT (GeV)");
     h1->GetYaxis()->SetTitle("fr");
     ...
     TLegend *l1 = new TLegend(0.47,0.55,0.78,0.78);
     l1->SetBorderSize(2);
     l1->SetFillColor(0);
...
/*     TLatex *t = new TLatex();
     ...
     t->Draw();
*/
     c01->SaveAs("csc2-frpt.eps");
     c01->SaveAs("csc2-frpt.png");
     c01->SaveAs("csc2-frpt.pdf");
