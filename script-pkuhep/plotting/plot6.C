...
#include <vector.h>
     ...
     TLegend *l1 = new TLegend(0.15,0.55,0.5,0.78);
     l1->SetBorderSize(2);
     l1->SetFillColor(0);
...
/*     TLatex *t = new TLatex();
     ...
     t->Draw();
*/
     c01->SaveAs("csc2-fr.eps");
     c01->SaveAs("csc2-fr.png");
     c01->SaveAs("csc2-fr.pdf");
