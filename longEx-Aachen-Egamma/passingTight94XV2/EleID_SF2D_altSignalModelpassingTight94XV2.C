...
// ------------>Primitives in pad: canScaleFactor_altSignalModel_1
   ...
   canScaleFactor_altSignalModel_1->Range(-3.571429,0.7131609,3.571429,2.919615);
   ...
   Double_t yAxis9[7] = {10, 20, 35, 50, 100, 200, 500}; 
   
   TH2F *h2_uncertaintiesEGamma_copy = new TH2F("h2_uncertaintiesEGamma_copy","e/#gamma absolute SF syst: altSignalModel ",10, xAxis9,6, yAxis9);
...
// ------------>Primitives in pad: canScaleFactor_altSignalModel_2
   ...
   canScaleFactor_altSignalModel_2->Range(-3.571429,0.7131609,3.571429,2.919615);
   ...
   Double_t yAxis10[7] = {10, 20, 35, 50, 100, 200, 500}; 
   
   TH2F *h2_uncertaintiesEGamma_copy = new TH2F("h2_uncertaintiesEGamma_copy","e/#gamma relative SF syst: altSignalModel ",10, xAxis10,6, yAxis10);
   h2_uncertaintiesEGamma_copy->SetBinError(13,0.04318612);
   h2_uncertaintiesEGamma_copy->SetBinError(14,0.05306064);
   h2_uncertaintiesEGamma_copy->SetBinError(15,0.1033862);
   h2_uncertaintiesEGamma_copy->SetBinError(16,0.04120367);
