...
//   TH2D* h3 = new TH2D("h3", "gen && reco selection",5, ptBins,5,ptBins);
   ...
   TH1D* hist1[5]; 
   TH1D* hist5[5];
   TH2D* h2 = new TH2D("h2", "reco && gen selection", 5, 0,400,20,0,400);
   TH1D* hist2= new TH1D("hist",name+Form("\t\t %0.f<leading p_{T}^{reco}<%0.f  reco;leding p_{T}^{reco};yields",ptBins[0],ptBins[5]),20,0,400);
   TH1D* hist4= new TH1D("hist4",name+Form("\t\t %0.f<leading p_{T}^{gen}<%0.f  gen;leding p_{T}^{gen};yields",ptBins[0],ptBins[5]),5,0,400);
