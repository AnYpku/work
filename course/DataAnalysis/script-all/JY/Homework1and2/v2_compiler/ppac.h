...
// Sun Feb 28 17:28:52 2016 by ROOT version 5.34/21
// from TTree t1//rarf/w/r04/chenrj/root/runmust20080.root
// found on file: ../../runmust20080.root
//////////////////////////////////////////////////////////
...
// parameters and function for output tree
   
	 Float_t        PPACF8Pos[5][5];
	 Int_t          cnt[2];
	 Bool_t         PPACFlag[5][3];
	 Bool_t         ValidEvent[2];
	 Float_t        FitFactor[2][3];
	 Float_t        Target[2];
	 Bool_t         InTarget;

   virtual void  BranchOpt(TTree *t);
   virtual void  Loop(TTree *t);
   virtual void  TrackPPAC();
   virtual void  ResetVal();
};

#endif //must keep this line unchanged

#ifdef ppac_cxx //must keep this line unchanged
ppac::ppac(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../analysis/runmust20087.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../analysis/runmust20087.root");
      }
      f->GetObject("t1",tree);
