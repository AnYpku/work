...
// Thu Mar  8 12:01:56 2018 by ROOT version 6.06/08
// from TTree t1//rarf/w/r04/chenrj/root/runmust20082.root
// found on file: MUST2@BigRIPS/runmust20082.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("MUST2@BigRIPS/runmust20080.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/data/data/MUST2@BigRIPS/runmust20080.root");
      }
      f->GetObject("t1",tree);
