...
// Tue Mar 13 14:12:10 2018 by ROOT version 6.08/06
// from TTree t1//rarf/w/r04/chenrj/root/runmust20087.root
// found on file: runmust20087.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
 ...
 //TMust2Data      *Must2;
   ...
   void TrigSelection(Int_t tGATCONF,Int_t tTrig[16]);
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/data/data/MUST2@BigRIPS/runmust20087.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/data/data/MUST2@BigRIPS/runmust20087.root");
      }
      f->GetObject("t1",tree);
