...
// Mon Mar 19 10:05:50 2018 by ROOT version 6.10/08
// from TTree t1//rarf/w/r04/chenrj/root/runmust20092.root
// found on file: runmust20092.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         FPdE[12][3];
   Float_t         OK[6];
   Float_t         PPAC[5][5];//after cut 5 ppac face state
   Float_t         X;
   Float_t         Y;
   Float_t         ZZ=0;
   Float_t         num=0;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("runmust20092.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("runmust20092.root");
      }
      f->GetObject("t1",tree);
