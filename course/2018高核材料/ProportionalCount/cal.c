...
Double_t u[5];
Double_t E[5]={5.414,6.403,8.047,8.643,9.885};
Double_t EE[5];
TGraph *gg ;
TMultiGraph *mg = new TMultiGraph();
Int_t p=0;
for(Int_t i=1;i<6;i++){
   infile.open(Form("/Users/andy/work/course/2018高核材料/ProportionalCount/txt/kedu%d.txt",i),ios::in);
if(!infile.is_open())
   continue;
...
l1->AddEntry(g[0],"^{24}Cr ");
l1->AddEntry(g[1],"^{26}Fe ");
l1->AddEntry(g[2],"^{29}Cu ");
...
mg->Add(gg);
mg->Draw("AP");
mg->SetTitle("the distribution of different elements");
