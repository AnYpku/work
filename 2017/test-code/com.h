...
// Tue Mar 19 07:46:39 2019 by ROOT version 6.10/09
// from TTree demo/demo
// found on file: cutla-outZA.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void     Loop(TString name,TString title);
...
#ifdef com_cxx
com::com(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("cutla-outZA.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("cutla-outZA.root");
      }
...
Int_t com::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t com::LoadTree(Long64_t entry)
{
